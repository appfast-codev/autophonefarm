...
module.exports = syrup.serial()
  ...
  .define(function(options, adb, properties, abi, sdk) {
    ...
    return stop()
      ...
      .then(function() {
        return {
          bin: resources.bin ? resources.bin.dest : null
        , lib: resources.lib ? resources.lib.dest : null
        , run: function(cmd) {
            if (sdk.level >= 30) {
              return Promise.reject(new Error('Minicap not supported on Android 11+ (SDK ' + sdk.level + ')'))
            }
