...
module.exports = syrup.serial()
  ...
  .define(function(options, adb, router, minitouch, flags, sdk, display) {
    ...
    function TouchConsumer(config) {
      ...
      this.writeQueue = []
      this.fallbackMode = (sdk.level >= 30)
      this._fallbackStart = null
      this._fallbackLast = null
    }
